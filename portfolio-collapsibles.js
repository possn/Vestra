/* Vestra Portfolio Collapsibles v1.5 — canonical per-section collapsing without legacy global toolbar. */
...
function style(){if(document.getElementById('vestra-portfolio-collapsibles-style'))return;const link=document.createElement('link');link.id='vestra-portfolio-collapsibles-style';link.rel='stylesheet';link.href='portfolio-collapsibles.css?v=1.1';document.head.appendChild(link)}
...
window.VestraPortfolioCollapsibles=Object.freeze({refresh:install,version:'1.5'});
})();
