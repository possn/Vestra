/* Vestra Portfolio UI v2.4 — compact exploration hierarchy with less repeated chrome. */
(() => {
  'use strict';
  ...
  function openFirstActive(c){
    ...
    const focused=focusCard(c,first);if(active==='optimize')syncOptimizeGuide(c,focused);return focused;
  }
