/* Vestra Market Dossier Signals v1.0 — read-only catalyst, recovery and drawdown panels. */
(() => {
  'use strict';
  ...
  function create(options={}){
    ...
    return Object.freeze({catalystPanel,recoveryPanel,drawdownPanel});
  }
