...
(() => {
  ...
  async function loadBase(){
    ...
    loading=(async()=>{
      ...
      if(!d||Number(d.schema_version||0)<2||!Array.isArray(d.trades)||!Array.isArray(d.members))throw new Error('Feed político inválido ou antigo');
