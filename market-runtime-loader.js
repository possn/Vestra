...
(() => {
  ...
  const SRC = 'market.js?v=20260926rotation3';
  ...
  function ensurePortfolioHelpers() {
    ...
    if (!portfolioHelpersPromise) {
      ...
      portfolioHelpersPromise = loadHelper('VestraNavigation', 'portfolio-sheet-navigation.js?v=1.5')
        ...
        .then(() => loadHelper('VestraPortfolioCardClassifier', 'portfolio-card-classifier.js?v=1.8'))
        .catch(err => {
  ...
  function loadCore() {
    ...
    return new Promise((resolve, reject) => {
      ...
      if (!existing) {
        script.src = 'market.js?v=20260926rotation3';
        script.async = true;
