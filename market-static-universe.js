/* Vestra Market static universe loader v1.30 */
(() => {
  'use strict';
  ...
  function ensureMetalsCompanion() { loadCompanion('VestraMetals','script[data-vestra-market-metals]','market-metals.js?v=1.2','vestraMarketMetals'); }
  ...
  function ensurePortfolioSheetSuite() {
    ...
    portfolioSheetSuitePromise = loadOrderedCompanion('VestraPortfolioFocus','script[data-vestra-portfolio-focus]','vestra-portfolio-focus.js?v=1.2','vestraPortfolioFocus')
      .then(api => api && loadOrderedCompanion('VestraSwapLab','script[data-vestra-swap-lab]','vestra-swap-lab.js?v=1.1','vestraSwapLab'))
      .then(api => api && loadOrderedCompanion('VestraPortfolioUI','script[data-vestra-portfolio-ui]','vestra-portfolio-ui.js?v=1.5','vestraPortfolioUi'))
      ...
      .then(api => api && loadOrderedCompanion('VestraPortfolioHierarchy','script[data-vestra-portfolio-hierarchy]','vestra-portfolio-hierarchy.js?v=1.7','vestraPortfolioHierarchy'))
  ...
  ensureWeeklyEventsCompanion(); ensureWeeklyEventsNavigation(); ensureDashboardUiRefresh(); ensureDashboardDailyNews(); ensureDashboardMarketSentiment(); ensureDashboardPortfolioConcentration();
  ...
  window.VestraMarketStaticUniverse = Object.freeze({
    ...
    companionLoadTimeoutMs: COMPANION_LOAD_TIMEOUT_MS, version: '1.30',
  });
})();
