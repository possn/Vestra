...
(() => {
  ...
  function ensureOpportunitySuite() {
    ...
    opportunitySuitePromise = loadOrderedCompanion(
      'VestraMarketOpportunities',
      'script[data-vestra-market-opportunities]',
      'market-opportunities.js?v=1.2',
      'vestraMarketOpportunities'
    ).then(base => {
      if (!base) return null;
      return loadOrderedCompanion(
        'VestraMarketOpportunityLenses',
        'script[data-vestra-market-opportunity-lenses]',
