/* Vestra Market static universe loader v1.23 */
(() => {
  'use strict';
  ...
  function ensureDashboardPortfolioConcentration() { loadCompanion('VestraDashboardPortfolioConcentration','script[data-vestra-dashboard-portfolio-concentration]','dashboard-portfolio-concentration.js?v=1.5','vestraDashboardPortfolioConcentration'); }
  ...
  window.VestraMarketStaticUniverse = Object.freeze({
    ...
    companionLoadTimeoutMs: COMPANION_LOAD_TIMEOUT_MS, version: '1.23',
  });
})();
