...
(() => {
  ...
  function ensurePortfolioSheetSuite() {
    ...
    portfolioSheetSuitePromise = loadOrderedCompanion('VestraSwapLab','script[data-vestra-swap-lab]','vestra-swap-lab.js?v=1.2','vestraSwapLab')
      .then(api => api && loadOrderedCompanion('VestraPortfolioUI','script[data-vestra-portfolio-ui]','vestra-portfolio-ui.js?v=2.9','vestraPortfolioUi'))
      ...
      .then(api => api && loadOrderedCompanion('VestraPortfolioHierarchy','script[data-vestra-portfolio-hierarchy]','vestra-portfolio-hierarchy.js?v=2.1','vestraPortfolioHierarchy'))
