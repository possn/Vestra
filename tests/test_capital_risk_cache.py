...
def test_archives_discovery_uses_exact_cik_and_full_submission_url():
    ...
    assert grouped[320193][0]["archive_url"] == "https://www.sec.gov/Archives/edgar/data/320193/0000320193-26-000090.txt"
...
def test_previous_result_reused_only_for_exact_version_and_fingerprint():
    ...
    assert capital_risk._apply_previous_if_unchanged(DummyMetrics(), previous, "different") is False
