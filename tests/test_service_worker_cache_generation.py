...
class ServiceWorkerCacheGenerationTests(unittest.TestCase):
    ...
    def test_bounded_precache_install_uses_a_fresh_cache_generation(self):
        self.assertIn('const CACHE_NAME = "vestra-cache-v174";', self.source)
        self.assertNotIn('const CACHE_NAME = "vestra-cache-v173";', self.source)
        ...
        self.assertIn('"app-xlsx-loader.js"', self.source)
        self.assertIn('"./portfolio-sector-explorer.js"', self.source)
        self.assertIn('"./portfolio-sector-explorer.css"', self.source)
        self.assertIn('"portfolio-sector-explorer.js"', self.source)
