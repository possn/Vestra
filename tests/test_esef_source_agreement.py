...
import source_agreement as agreement
...
class ESEFSourceAgreementTests(unittest.TestCase):
    ...
    def test_same_period_four_metrics_measure_agreement_without_changing_values(self):
        ...
        self.assertTrue(agreement.attach_esef_same_period_observation(m, "2025-12-31", esef_values))
        self.assertEqual(annual["gross_margin"], 0.40, "diagnostic observation must not mutate Yahoo value")
        self.assertIn(agreement.ESEF_AGREEMENT_OBSERVATION_KEY, annual)
        ...
        self.assertNotIn(agreement.ESEF_AGREEMENT_OBSERVATION_KEY, row["annual_quality_history"][0])
        ...
        self.assertEqual(row["source_agreement_method"], agreement.SOURCE_AGREEMENT_METHOD)
        ...
        self.assertEqual(row["data_provenance"]["agreement_method"], agreement.SOURCE_AGREEMENT_METHOD)
        self.assertEqual(
    ...
    def test_mismatched_period_is_not_attached_or_measured(self):
        ...
        self.assertFalse(agreement.attach_esef_same_period_observation(
            m,
            "2024-12-31",
    ...
    def test_one_metric_keeps_percentage_unmeasured(self):
        ...
        self.assertTrue(agreement.attach_esef_same_period_observation(m, "2025-12-31", {"roe": 0.16}))
        row = {
            "data_sources": ["Yahoo Finance", "ESEF / filings.xbrl.org"],
            "annual_quality_history": m.annual_quality_history,
            "esef_period_end": "2025-12-31",
