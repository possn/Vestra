...
class RuntimeJsReachabilityTests(unittest.TestCase):
    ...
    def test_model_validation_is_reachable_dynamically(self):
        ...
        self.assertIn('market-company-brief.js', report['edges']['market-runtime-loader.js'])
        self.assertIn('market-model-validation.js', report['edges']['market-company-brief.js'])
