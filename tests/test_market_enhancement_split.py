...
class MarketEnhancementSplitTests(unittest.TestCase):
    def test_hotfix_uses_canonical_modules_not_legacy_overlays(self):
        ...
        for module in ('portfolio-collapsibles.js?v=1.7', 'portfolio-card-classifier.js?v=1.8'):
    ...
    def test_classifier_preserves_all_portfolio_kinds_hints_and_static_styles_without_hidden_shortcuts(self):
        ...
        for kind in ('research','priority','map','reinforce','review','overlap','swap','etfopt','scenario','target','history','risk','stress'):
    ...
    def test_market_dossier_controls_use_static_stylesheet(self):
        ...
        self.assertIn("market-dossier-controls.css?v=1.2", js)
        self.assertIn("link.rel = 'stylesheet'", js)
        self.assertNotIn("document.createElement('style')", js)
