...
assert.strictEqual(typeof api.ensureMarketOpportunities, 'function');
assert.strictEqual(typeof api.ensureMarketOpportunityLenses, 'function');
assert.strictEqual(typeof api.ensureMarketMetals, 'function');
assert.strictEqual(typeof api.ensureMarketCompanyBrief, 'function');
...
assert(source.includes('dashboard-weekly-events.js?v=2.2'));
...
assert(source.includes('dashboard-daily-news.js?v=1.5'), 'daily dashboard news must be a reachable runtime companion');
...
assert(source.includes('market-opportunity-lenses.js?v=3.0'));
assert(source.includes('market-metals.js?v=1.0'));
assert(source.includes('market-company-brief.js?v=2.1'));
assert(source.indexOf('ensureMarketOpportunities();') < source.indexOf('ensureMarketOpportunityLenses();'));
...
assert(!eagerTail.includes('ensureMarketOpportunities();'));
assert(!eagerTail.includes('ensureMarketOpportunityLenses();'));
assert(!eagerTail.includes('ensureMarketMetals();'));
assert(!eagerTail.includes('ensureMarketCompanyBrief();'));
