...
assert(source.includes('market-scanner-data.js?v=1.1'));
assert(source.includes('market-analysis-tools-runtime.js?v=1.0'));
assert(source.includes('dashboard-weekly-events.js?v=1.2'));
...
assert(source.includes('dashboard-ui-refresh.js?v=1.2'));
assert(source.includes('mobile-ui-refresh.js?v=1.3'));
