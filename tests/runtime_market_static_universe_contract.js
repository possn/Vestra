...
assert(source.includes('dashboard-weekly-events.js?v=1.9'));
...
assert(source.includes('dashboard-daily-news.js?v=1.1'), 'daily dashboard news must be a reachable runtime companion');
