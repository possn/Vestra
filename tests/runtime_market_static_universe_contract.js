...
assert(source.includes('dashboard-ui-refresh.js?v=1.5'));
assert(source.includes('dashboard-daily-news.js?v=1.5'), 'daily dashboard news must be a reachable runtime companion');
assert(source.includes('dashboard-market-sentiment.js?v=1.0'), 'market sentiment must be a reachable dashboard companion');
