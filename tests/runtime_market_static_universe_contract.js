...
assert(source.includes('dashboard-market-sentiment.js?v=1.3'), 'market sentiment must be a reachable dashboard companion');
assert(source.includes('dashboard-portfolio-concentration.js?v=2.2'), 'portfolio concentration must be a reachable dashboard companion');
