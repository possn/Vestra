...
assert(source.includes('dashboard-market-sentiment.js?v=1.5'), 'market sentiment must be a reachable dashboard companion');
assert(source.includes('dashboard-portfolio-concentration.js?v=2.5'), 'portfolio concentration must be a reachable dashboard companion');
...
assert(source.includes('vestra-swap-lab.js?v=1.2'));
assert(source.includes('vestra-portfolio-ui.js?v=2.4'));
assert(source.includes('portfolio-diagnostics.js?v=1.2'));
assert(source.includes('portfolio-dossier-routing.js?v=1.5'));
assert(source.includes('vestra-portfolio-hierarchy.js?v=2.1'));
