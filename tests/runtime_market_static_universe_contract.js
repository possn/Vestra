...
assert(source.includes('dashboard-weekly-events.js?v=2.3'));
...
assert(source.includes('dashboard-daily-news.js?v=1.6'), 'daily dashboard news must be a reachable runtime companion');
assert(source.includes('dashboard-market-sentiment.js?v=1.1'), 'market sentiment must be a reachable dashboard companion');
