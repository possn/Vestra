...
assert.strictEqual(typeof api.openTicker, 'function');
...
assert(source.includes('window.VestraNavigation'));
assert(source.includes('nav.openCompany'));
assert(!source.includes('VestraMarketData?.openDossier'));
assert(!source.includes("setView('market')"));
