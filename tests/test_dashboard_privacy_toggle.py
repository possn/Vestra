...
class DashboardPrivacyToggleTests(unittest.TestCase):
    ...
    def test_lazy_market_runtime_remains_intact(self):
        self.assertIn('src="market-runtime-loader.js?v=1.0"', INDEX)
        self.assertNotIn('src="market.js?v=20260831v2"', INDEX)
        self.assertIn("VestraMarketLoader", APP)
