...
// Run the deferred navigation while keeping later lifecycle retries separate.
assert(runtime.timers.length > 0, 'safe update must schedule its cache-busted navigation');
