...
class LazyMarketCoreTests(unittest.TestCase):
    ...
    def test_portfolio_helpers_load_in_dependency_order_before_core(self):
        ...
        classifier = self.loader.index("portfolio-card-classifier.js?v=1.8", collapsibles)
        core = self.loader.index("script.src = 'market.js?v=20260926rotation3';", classifier)
