/* Vestra Market Company Brief v1.4 — canonical dossier/company description repair + research diagnostics bootstrap. */
(() => {
'use strict';
...
function loadScript(id,src,ready){if(ready||document.getElementById(id))return;const s=document.createElement('script');s.id=id;s.src=src;s.defer=true;document.head.appendChild(s)}
...
loadGlobalMarketSearch();
if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',start,{once:true});else start();
window.VestraMarketCompanyBrief=Object.freeze({brief,refresh:repair,version:'1.4'});
})();
