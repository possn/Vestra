...
function ageText(){ return marketRowUI?.ageText() || ''; }
  ...
  function renderWeeklyRotation(){
    ...
    if(!rows.length) return `<div class="market-rotation market-rotation--waiting" aria-live="polite"><div class="market-perspective-head"><div><small>WEEKLY ROTATION · PROXY</small><h4>Para onde está a rodar o mercado?</h4></div><span class="market-rotation-status">A preparar</span></div><div class="market-rotation-wait"><strong>A primeira leitura semanal ainda está a ser calculada.</strong><span>A tabela aparece automaticamente aqui quando houver 5 dias de dados suficientes. Não tens de abrir este card.</span></div></div>`;
